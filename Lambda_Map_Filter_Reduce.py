...
# ---------- PROBLEM ----------
# Create a function that receives a list and a function. The function passed will return True or False if a list
# value is odd. The surrounding function will return a list of odd numbers.
def is_it_odd(num):
