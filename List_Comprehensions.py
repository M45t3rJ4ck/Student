...
# Note: While they are super powerful, try not to make list comprehensions that are hard to figure out for others
...
# Generate a list of 50 values and take them to the power of 2 and return all that are multiples of 8
